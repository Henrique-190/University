...
%
  \ensuremath{\alt{\Varid{outExpAr}\comp \underline{\Conid{X}}}{\Varid{outExpAr}\comp \alt{\Conid{N}}{\alt{\Varid{bin}}{\uncurry{\Conid{Un}}}}}\mathrel{=}i_1\comp i_2}
%
\just\equiv{ Eq-+ }
%
\left\{
...
\centerline{\xymatrix{
   ExprAr A \ar[d]_-{\ensuremath{\Varid{f}}}
                \ar@/^2pc/ [rr]^-{\ensuremath{\Varid{outExprAr}}} & \qquad \cong
&   1 + (A + (BinOp \times (ExprAr A \times ExprAr A) + UnOp \times ExpAr A))  \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{f}\times\Varid{f})\mathbin{+}\Varid{id}\times\Varid{f}))}} 
                                     \ar@/^2pc/ [ll]^-{\ensuremath{\Varid{inExprAr}}}
\\
    \ensuremath{\Varid{a}} &  & 1 + (A + (BinOp \times (a \times a) + UnOp \times a))\ar[ll]
}}
...
\begin{eqnarray*}
\start
  recExpAr\ f = {\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{f}\times\Varid{f})\mathbin{+}\Varid{id}\times\Varid{f}))}} 
%
...
\column{7}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\alt{\Varid{g1}\;\Varid{a}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;\Varid{a}\mathrel{=}\underline{\Varid{a}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\mathrel{=}\alt{\Varid{g3}}{\Varid{g4}}\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g3}\mathrel{=}\Varid{id}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g4}\mathrel{=}\alt{\Varid{g5}}{\Varid{g6}}\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g5}\;(\Conid{Sum},(\Varid{a},\Varid{b}))\mathrel{=}\Varid{a}\mathbin{+}\Varid{b}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g5}\;(\Conid{Product},(\Varid{a},\Varid{b}))\mathrel{=}\Varid{a}\mathbin{*}\Varid{b}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g6}\;(\Conid{Negate},\Varid{a})\mathrel{=}\mathbin{-}\Varid{a}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g6}\;(\Conid{E},\Varid{a})\mathrel{=}\Varid{expd}\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
---
\newline
...
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b})\mathrel{=}\mathbf{if}\;\Varid{op}\equiv \Conid{Product}\mathrel{\wedge}(\Varid{a}\equiv \Conid{N}\;\mathrm{0}\mathrel{\vee}\Varid{b}\equiv \Conid{N}\;\mathrm{0})\;\mathbf{then}\;i_2\;(i_1\;\mathrm{0})\;\mathbf{else}\;i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{a},\Varid{b})))){}\<[E]%
\\
...
\end{eqnarray*}
Como cada coproduto corresponde a um either, então através do diagrama podesmos chegar ao seguinte gene do catamorfismo eval\_exp, aplicando as regras de derivação da soma e do produto:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\mathrel{=}\underline{(\Conid{X},\Conid{N}\;\mathrm{1})}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\mathrel{=}\alt{\Varid{g3}}{\Varid{g4}}\;\mathbf{where}{}\<[E]%
\\
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{g4}\mathrel{=}\alt{{}\<[18]%
\>[18]{}\Varid{g5}}{\Varid{g6}}\;\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g5}\;(\Conid{Sum},((\Varid{ex1},\Varid{ex2}),(\Varid{ex3},\Varid{ex4})))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;\Varid{ex1}\;\Varid{ex3},\Conid{Bin}\;\Conid{Sum}\;\Varid{ex2}\;\Varid{ex4}){}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g5}\;(\Conid{Product},((\Varid{ex1},\Varid{ex2}),(\Varid{ex3},\Varid{ex4})))\mathrel{=}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}(\Conid{Bin}\;\Conid{Product}\;\Varid{ex1}\;\Varid{ex3},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{ex1}\;\Varid{ex4})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{ex2}\;\Varid{ex3})){}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g6}\;(\Conid{Negate},(\Varid{ex1},\Varid{ex2}))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{ex1},\Conid{Un}\;\Conid{Negate}\;\Varid{ex2}){}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g6}\;(\Conid{E},(\Varid{ex1},\Varid{ex2}))\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{ex1},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{ex1})\;\Varid{ex2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
---
\begin{hscode}\SaveRestoreHook
...
\column{7}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\;\Varid{a}\mathrel{=}\alt{\Varid{g1}\;\Varid{a}}{\Varid{g2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;\Varid{a}\mathrel{=}\underline{(\Varid{a},\mathrm{1})}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\mathrel{=}\alt{\Varid{g3}}{\Varid{g4}}\;\mathbf{where}{}\<[E]%
\\
...
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g5}\;(\Conid{Sum},((\Varid{ex1},\Varid{ex2}),(\Varid{ex3},\Varid{ex4})))\mathrel{=}(\Varid{ex1}\mathbin{+}\Varid{ex3},\Varid{ex2}\mathbin{+}\Varid{ex4}){}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g5}\;(\Conid{Product},((\Varid{ex1},\Varid{ex2}),(\Varid{ex3},\Varid{ex4})))\mathrel{=}(\Varid{ex1}\mathbin{*}\Varid{ex3},\Varid{ex1}\mathbin{*}\Varid{ex4}\mathbin{+}\Varid{ex2}\mathbin{*}\Varid{ex3}){}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g6}\;(\Conid{Negate},(\Varid{ex1},\Varid{ex2}))\mathrel{=}(\Varid{negate}\;\Varid{ex1},\Varid{negate}\;\Varid{ex2}){}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{g6}\;(\Conid{E},(\Varid{ex1},\Varid{ex2}))\mathrel{=}(\Varid{expd}\;\Varid{ex1},\Varid{ex2}\mathbin{*}(\Varid{expd}\;\Varid{ex1})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\mathbin{::}\Conid{Integral}\;\Varid{c}\Rightarrow (\Varid{c},\Varid{c},\Varid{c})\to (\Varid{c},\Varid{c},\Varid{c}){}\<[E]%
\\
\>[B]{}\Varid{loop}\;(\Varid{cF},\Varid{cS},\Varid{cT})\mathrel{=}(\Varid{cF}\mathbin{*}\Varid{cS}\div \Varid{cT},\Varid{cS}\mathbin{+}\mathrm{4},\Varid{cT}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{2},\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{prj}\;(\Varid{cF},\Varid{cS},\Varid{cT})\mathrel{=}\Varid{cF}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
por forma a que
\begin{hscode}\SaveRestoreHook
...
É-nos dito no enunciado que \ensuremath{\Varid{avg\char95 aux}\mathrel{=}\cata{\alt{\Varid{b}}{\Varid{q}}}} = \ensuremath{\conj{\Varid{avg}}{\length }}, então,
o raciocínio é partir de \ensuremath{\alt{\Varid{b}}{\Varid{q}}} e tentar obter um split que permita ter
...
%
  \ensuremath{\alt{\Varid{id}\comp \Varid{b}}{\Varid{id}\comp \Varid{q}}}
%
\just\equiv{ Fusão-+ }
%
...
\begin{eqnarray}
\start
  \ensuremath{\conj{\alt{\p1\comp \Varid{b}}{\p1\comp \Varid{q}}}{\alt{\p2\comp \Varid{b}}{\p2\comp \Varid{q}}}\mathrel{=}\conj{\Varid{avg}}{\length }}
%
\just\equiv{ Fokkinga }
%
...
%
  \ensuremath{\begin{lcbr}\Varid{avg}\comp \alt{\Varid{nil}}{\Varid{cons}}\mathrel{=}\alt{\p1\comp \Varid{b}}{\p1\comp \Varid{q}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length })\\\length \comp \alt{\Varid{nil}}{\Varid{cons}}\mathrel{=}\alt{\p2\comp \Varid{b}}{\p2\comp \Varid{q}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length })\end{lcbr}}
%
\just\equiv{ fusão-+ }
%
\ensuremath{\begin{lcbr}\alt{\Varid{avg}\comp \Varid{nil}}{\Varid{avg}\comp \Varid{cons}}\mathrel{=}\alt{\p1\comp \Varid{b}}{\p1\comp \Varid{q}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length })\\\alt{\length \comp \Varid{nill}}{\Varid{len}\comp \Varid{cons}}\mathrel{=}\alt{\p2\comp \Varid{b}}{\p2\comp \Varid{q}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length })\end{lcbr}}
%
\just\equiv{ Def-x }
%
\left\{
   \begin{array}{lll}
      \ensuremath{\alt{\Varid{avg}\comp \Varid{nil}}{\Varid{avg}\comp \Varid{cons}}\mathrel{=}\alt{\p1\comp \Varid{b}}{\p1\comp \Varid{q}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{id}\comp \p1}{\conj{\Varid{avg}}{\Varid{len}}\comp \p2})}\\
      \ensuremath{\alt{\length \comp \Varid{nill}}{\Varid{len}\comp \Varid{cons}}\mathrel{=}\alt{\p1\comp \Varid{b}}{\p1\comp \Varid{q}})\comp (\Varid{id}\mathbin{+}\conj{\Varid{id}\comp \p1}{\conj{\Varid{avg}}{\Varid{len}}\comp \p2})}\\
    \end{array}
\right.
%
\just\equiv{ Absorção-+ }
%
\ensuremath{\begin{lcbr}\alt{\Varid{avg}\comp \Varid{nil}}{\Varid{avg}\comp \Varid{cons}}\mathrel{=}\alt{\p1\comp \Varid{b}\comp \Varid{id}}{\p1\comp \Varid{q}\comp \conj{\Varid{avg}}{\Varid{len}}\comp \p2}\\\alt{\length \comp \Varid{nill}}{\Varid{len}\comp \Varid{cons}}\mathrel{=}\alt{\p2\comp \Varid{b}\comp \Varid{id}}{\p2\comp \Varid{q}\comp \conj{\Varid{avg}}{\Varid{len}}\comp \p2}\end{lcbr}}
%
...
\left\{
   \begin{array}{lll}
    ...
    \ensuremath{(\Varid{avg}\comp \Varid{cons})\mathrel{=}(\p1\comp \Varid{q}\comp \conj{\Varid{avg}}{\Varid{len}}\comp \p2)}\\
    \ensuremath{(\length \comp \Varid{nill})\mathrel{=}(\p2\comp \Varid{b}\comp \Varid{id})}\\
    \ensuremath{(\Varid{len}\comp \Varid{cons})\mathrel{=}(\p2\comp \Varid{q}\comp \conj{\Varid{avg}}{\Varid{len}}\comp \p2)}\\
    \end{array}
\right.
%
...
\left\{
   \begin{array}{lll}
      \ensuremath{\Varid{avg}\;(\Varid{nil}\;\Varid{l})\mathrel{=}\p1\;(\Varid{b}\;\Varid{l})}\\
      \ensuremath{\Varid{avg}\;(\Varid{cons}\;(\Varid{a},\Varid{l}))\mathrel{=}\p1\;(\Varid{q}\;(\Varid{a},(\Varid{avg}\;\Varid{l},\length \;\Varid{l})))}\\
      \ensuremath{\length \;(\Varid{nil}\;\Varid{l})\mathrel{=}\p2\;(\Varid{b}\;\Varid{l})}\\
      \ensuremath{\length \;(\Varid{cons}\;(\Varid{a},\Varid{l}))\mathrel{=}\p2\;(\Varid{q}\;(\Varid{a},(\Varid{avg}\;\Varid{l},\length \;\Varid{l})))}\\
  \end{array}
\right.
%
...
\left\{
   \begin{array}{lll}
      \ensuremath{\p1\;\Varid{b}\mathrel{=}\mathrm{0}}\\
      \ensuremath{\Varid{avg}\;(\Varid{a}\mathbin{:}\Varid{l})\mathrel{=}\p1\;(\Varid{q}\;(\Varid{a},(\Varid{avg}\;\Varid{l},\length \;\Varid{l}))}\\
      \ensuremath{\p2\;\Varid{b}\mathrel{=}\mathrm{0}}\\
      \ensuremath{\length \;(\Varid{a}\mathbin{:}\Varid{l})\mathrel{=}\p2\;(\Varid{q}\;(\Varid{a},(\Varid{avg}\;\Varid{l},\length \;\Varid{l}))}
  \end{array}
\right.
\qed
\end{eqnarray}

Como se compreende, com \ensuremath{\p1\;\Varid{b}\mathrel{=}\mathrm{0}}, qualquer que seja o b, o resultado é sempre 0, logo \ensuremath{\Varid{b}\mathrel{=}\underline{\Varid{b}}}, ou seja, b é uma função constante, tendo-se como solução:

\begin{eqnarray}
\start
\left\{
   \begin{array}{lll}
      \ensuremath{\p1\;\underline{\Varid{b}}\mathrel{=}\mathrm{0}}\\
      \ensuremath{\Varid{avg}\;(\Varid{a}\mathbin{:}\Varid{l})\mathrel{=}\p1\;(\Varid{q}\;(\Varid{a},(\Varid{avg}\;\Varid{l},\length \;\Varid{l}))}\\
      \ensuremath{\p2\;\underline{\Varid{b}}\mathrel{=}\mathrm{0}}\\
      \ensuremath{\length \;(\Varid{a}\mathbin{:}\Varid{l})\mathrel{=}\p2\;(\Varid{q}\;(\Varid{a},(\Varid{avg}\;\Varid{l},\length \;\Varid{l}))}
  \end{array}
\right.
\qed
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{b}\mathrel{=}(\mathrm{0},\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{q}\;(\Varid{c},(\Varid{avg},\Varid{len}))\mathrel{=}((\Varid{avg}\mathbin{*}\Varid{len}\mathbin{+}\Varid{c})\mathbin{/}(\succ \;\Varid{len}){}\<[54]%
\>[54]{},\succ \;\Varid{len}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

Confrontando com esta solução com o obtido anteriormente, percebe-se também que o \ensuremath{\underline{\Varid{b}}} é o inicializador do ciclo \textit{for} (\ensuremath{\underline{\Varid{b}}\mathrel{=}(\mathrm{0},\mathrm{0})}) e o loop (b) é definido por \ensuremath{\Conid{Def}\;\Varid{avg}} dada pelo enunciado e \ensuremath{\Conid{Def}\;\length } de uma lista.
...
\begin{eqnarray*}
\start
    \ensuremath{\begin{lcbr}\Varid{avg}\comp \mathbf{in}\mathrel{=}\alt{\p1\comp \underline{\Varid{b}}}{\p1\comp \Varid{q}}\comp \Conid{F}\;\conj{\Varid{avg}}{\length }\\\Varid{len}\comp \mathbf{in}\mathrel{=}\alt{\p2\comp \underline{\Varid{b}}}{\p2\comp \Varid{q}}\comp \Conid{F}\;\conj{\Varid{avg}}{\length }\end{lcbr}}
%
\just\equiv{ Def in , Def F}
%
  \ensuremath{\begin{lcbr}\Varid{avg}\comp [\mskip1.5mu \Conid{Leaf},\Conid{Fork}\mskip1.5mu]\mathrel{=}\alt{\p1\comp \underline{\Varid{b}}}{\p1\comp \Varid{q}}\comp (\Varid{id}\mathbin{+}(\conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length }))\\\Varid{len}\comp [\mskip1.5mu \Conid{Leaf},\Conid{Fork}\mskip1.5mu]\mathrel{=}\alt{\p2\comp \underline{\Varid{b}}}{\p2\comp \Varid{q}}\comp (\Varid{id}\mathbin{+}(\conj{\Varid{avg}}{\length }\times\conj{\Varid{avg}}{\length }))\end{lcbr}}
%
\just\equiv{ Fusão-+; Def-x; Absorção-+; Eq-+; Natural-id; Igualdade Extensional; Def split; Def-comp}
%
\left\{
   \begin{array}{lll}
      \ensuremath{\Varid{avg}\;(\Conid{Leaf}\;\Varid{l})\mathrel{=}\p1\comp \underline{\Varid{b}}\;\Varid{l}}\\
      \ensuremath{\Varid{avg}\;(\Conid{Fork}\;(\Varid{esq},\Varid{dir}))\mathrel{=}\p1\;(\Varid{t}\;((\Varid{avg}\;\Varid{esq},\length \;\Varid{esq}),(\Varid{avg}\;\Varid{dir},\length \;\Varid{dir})))}\\
      \ensuremath{\length \;(\Conid{Leaf}\;\Varid{l})\mathrel{=}\p2\comp \underline{\Varid{b}}\;\Varid{l}}\\
      \ensuremath{\length \;(\Conid{Fork}\;(\Varid{esq},\Varid{dir}))\mathrel{=}\p2\;(\Varid{t}\;((\Varid{avg}\;\Varid{esq},\length \;\Varid{esq}),(\Varid{avg}\;\Varid{dir},\length \;\Varid{dir})))}\\
  \end{array}
\right.
%
...
\left\{
   \begin{array}{lll}
      \ensuremath{\Varid{l}\mathrel{=}\p1\;\Varid{b}}\\
      \ensuremath{\Varid{avg}\;(\Conid{Fork}\;(\Varid{esq},\Varid{dir}))\mathrel{=}\p1\;(\Varid{t}\;((\Varid{avg}\;\Varid{esq},\length \;\Varid{esq}),(\Varid{avg}\;\Varid{dir},\length \;\Varid{dir})))}\\
      \ensuremath{\mathrm{1}\mathrel{=}\p2\;\Varid{b}}\\
      \ensuremath{\length \;(\Conid{Fork}\;(\Varid{esq},\Varid{dir}))\mathrel{=}\p2\;(\Varid{t}\;((\Varid{avg}\;\Varid{esq},\length \;\Varid{esq}),(\Varid{avg}\;\Varid{dir},\length \;\Varid{dir})))}\\
  \end{array}
\right.
\qed
...
Conclui-se, então \ensuremath{\length \;\Conid{Fork}\mathrel{=}\length \;(\Conid{SubRightTree})\mathbin{+}\length \;(\Conid{SubLeftTree})} 
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{gene}\mathrel{=}\alt{\Varid{b}}{\Varid{t}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{b}\;\Varid{a}\mathrel{=}(\Varid{a},\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{t}\;((\Varid{esq1},\Varid{esq2}),(\Varid{dir1},\Varid{dir2}))\mathrel{=}((\Varid{esq1}\mathbin{*}\Varid{esq2}\mathbin{+}\Varid{dir1}\mathbin{*}\Varid{dir2})\mathbin{/}(\Varid{esq2}\mathbin{+}\Varid{dir2}),\Varid{esq2}\mathbin{+}\Varid{dir2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
